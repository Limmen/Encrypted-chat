...
public class ServerFrame extends JFrame
{
    ...
    Thread thread;
    public ServerFrame me;
    private Font Italic = new Font("Serif", Font.ITALIC, 12);
    private Font Bold = Italic.deriveFont(Italic.getStyle() | Font.BOLD);
    public ServerFrame(View view, ClientHandler server)
    {
        super("Server");
        try 
        {
    ...
    public void startup()
    {
	    ...
	    public void actionPerformed(ActionEvent arg0) 
                {   
                    view.newEntry("Server: ", entry.getText());
    ...
    {
        setLocation(f.getX() - f.getWidth() - f.getWidth()/6, f.getY());
        pack();
    }
}
